...
PICS = (environ.get('PICS', 'https://telegra.ph/file/59721bc889ac6fa04d2f5.jpg')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1977238156').split()]
...
CAPTION_BUTTON = "JION"
CAPTION_BUTTON_URL = "https://t.me/bot_developer_south_in"
