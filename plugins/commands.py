...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/bot_developer_south_in')
            ],
            [
                InlineKeyboardButton('⚡ JIONΞ ⚡', url=f"https://t.me/bot_developer_south_in"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JIONNEWΞ ⚡', url='https://t.me/newSouthmovieinhindid'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/bot_developer_south_in')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JIONΞ ⚡', url='https://t.me/newSouthmovieinhindi'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/bot_developer_south_in')
            ],[
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('Jionnew', url='https://t.me/newSouthmovieinhindi') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
